...
const skillIcons: SkillIcon[] = [
	...
	{ label: "Prisma", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/prisma/prisma-original.svg" },
	...
	{ label: "Supabase", src: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/supabase.svg" },
	...
	{ label: "Zod", src: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/zod.svg" },
	...
	return (
		<div className="container-page">
			...
			<main className="pt-24 pb-12">
				...
				{/* Journey */}
				<section className="bg-[rgb(37,47,67)] px-4 py-12 text-white">
				...
				{/* Skills */}
				<section className="bg-[#3f526f] px-4 py-14 text-white">
					<div className="mx-auto max-w-6xl">
